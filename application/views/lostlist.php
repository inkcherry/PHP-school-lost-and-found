...
<head>
    ...
    <link rel="stylesheet" href="css/lostlist/index.css">
    <link rel="stylesheet" type="text/css" href="css/lostlist/icon/iconfont.css">
     ...
     res_tmp=res;
        ...
        {  
           for(var i=res[0]['num'];i<9;i++)
           {
            ...
            document.getElementById(m).style.background='no-repeat url(<?php echo site_url() ?>upload/moren.png)';  
           }
        }      
   },
...
{  if(page==1)
  ...
  function detail(i)
  {  
    window.location.assign('index.php/user/c_detail?id='+res_tmp[i].id+'&flag=1');
  }
  function forfind()
  {
      thefind=$('#sear').val();
